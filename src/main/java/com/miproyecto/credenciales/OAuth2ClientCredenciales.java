...
public class OAuth2ClientCredenciales {
    ...
    private static final String PATH_P12KEY_SERVICE_ACCOUNT = "./src/main/resources/Llavep12.p12";
    
    //Cuenta de email que se genera en Developers Console en el momento de registrar un proyecto
    private static final String SERVICE_ACCOUNT_EMAIL = "XXXXXXXXXXX@developer.gserviceaccount.com";
    
    //Nombre de la aplicación tal como está registrada en Developers Console
    private static final String APPLICATION_NAME = "Mi Proyecto";
